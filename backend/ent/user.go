...
// was not loaded in eager-loading.
func (e UserEdges) BeesOrErr() ([]*Bee, error) {
	if e.loadedTypes[13] {
		return e.Bees, nil
	}
...
// QueryBees queries the "bees" edge of the User entity.
func (_m *User) QueryBees() *BeeQuery {
	return NewUserClient(_m.config).QueryBees(_m)
}
