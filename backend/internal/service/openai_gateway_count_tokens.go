...
func (s *OpenAIGatewayService) ForwardCountTokensAsAnthropic(
	...
	if err := applyTokenHiveHandoff(ctx, s.cfg, tokenHiveAccount, getAPIKeyIDFromContext(c), prepared.UpstreamModel, SourceOperationOpenAIResponsesInputTokens, upstreamReq); err != nil {
