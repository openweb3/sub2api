...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	web3IdentityRepository := repository.NewWeb3IdentityRepository(db)
	...
	gatewayService := service.ProvideGatewayService(tokenHiveRegistry, accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, compositeRouteResolver, balanceNotifyService, serviceUserPlatformQuotaRepository)
	...
	web3UserBalanceRepository := repository.NewWeb3UserBalanceRepository(client)
	web3TransferCacheInvalidator := service.NewWeb3TransferCacheInvalidator(billingCacheService, apiKeyService)
	web3TransferNotifier := service.NewWeb3TransferNotifier(userRepository, notificationEmailService)
	transferService := web3deposit.NewTransferService(web3AccountingRepository, web3TransferCacheInvalidator, web3TransferNotifier)
	...
	adminWeb3DepositHandler := admin.NewWeb3DepositHandler(configConfig, web3DepositRepository, web3DepositRepository, scannerRuntime, confluxNetworkRuntime, rescanJobRuntime)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, adminWeb3DepositHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	web3DepositHandler := handler.NewWeb3DepositHandler(configConfig, addressAllocator, scannerRuntime, web3DepositRepository, web3UserBalanceRepository, transferService)
	...
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, emailService, redisClient, configConfig, proxyRepository, web3DepositRepository, confluxNetworkRuntime)
