export default {
  ...
  auth: {
    ...
    errors: {
      ...
      WEB3_ADDRESS_INVALID: '钱包地址无效。',
      WEB3_CHAIN_ID_INVALID: '钱包网络标识无效。',
      WEB3_CHALLENGE_NOT_FOUND: '签名请求不存在或已过期。',
      WEB3_CHALLENGE_EXPIRED: '签名请求已过期，请重试。',
      WEB3_CHALLENGE_CONSUMED: '该签名请求已被使用。',
      WEB3_CHALLENGE_SESSION_MISMATCH: '该签名请求属于其他浏览器会话，请重试。',
      WEB3_SIGNATURE_INVALID: '钱包签名验证失败。',
      WEB3_IDENTITY_NOT_FOUND: '该钱包尚未注册。',
      WEB3_IDENTITY_EXISTS: '该钱包已注册。',
      WEB3_USERNAME_REQUIRED: '请输入用户名。',
      WEB3_USERNAME_TOO_SHORT: '用户名至少需要 2 个字符。',
      WEB3_USERNAME_TOO_LONG: '用户名不能超过 100 个字符。',
      WEB3_USERNAME_INVALID: '用户名包含无效字符。',
      WEB3_FRONTEND_URL_NOT_CONFIGURED: 'Web3 认证配置不完整，请联系管理员。',
    },
    web3: {
      emailTab: '邮箱',
      walletTab: 'Web3 钱包',
      loginTitle: 'Web3 登录',
      registerTitle: 'Web3 注册',
      loginSubtitle: '连接钱包并签名消息以继续',
      registerSubtitle: '使用 EVM 钱包地址创建账户',
      usernameLabel: '用户名',
      usernamePlaceholder: '输入你的用户名',
      usernameHint: '用户名为必填项，注册后仍可在个人资料中修改。',
      usernameErrors: {
        required: '请输入用户名。',
        tooShort: '用户名至少需要 2 个字符。',
        tooLong: '用户名不能超过 100 个字符。',
        invalid: '用户名包含无效字符。',
      },
      walletNotFound: '未检测到浏览器注入的 EVM 钱包，请安装或启用钱包扩展后刷新页面。',
      connectedWallet: '已连接钱包',
      chainId: '当前 EVM Chain ID：{chainId}',
      connectWallet: '连接钱包',
      connecting: '正在连接钱包...',
      waitingForSignature: '等待钱包签名...',
      signIn: '签名并登录',
      register: '签名并注册',
      noGas: '这里只签署链下消息，不会发送交易，也不会消耗 Gas。',
      eoaOnly: '第一版仅支持 EOA 钱包，不支持 Safe 等智能合约钱包。',
      recoveryWarning: '注册无需邮箱；第一版中如果钱包丢失，账户将无法找回。',
      settingsFailed: '加载认证设置失败。',
      connectFailed: '无法连接钱包。',
      accountMissing: '钱包未返回可用账户。',
      chainInvalid: '钱包返回了无效的 Chain ID。',
      loginFailed: 'Web3 登录失败，请重试。',
      registrationFailed: 'Web3 注册失败，请重试。',
    },
    ...
    affiliateCodeLabel: '推广邀请码',
    affiliateCodePlaceholder: '输入推广邀请码（可选）',
