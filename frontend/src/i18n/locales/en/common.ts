export default {
  ...
  auth: {
    ...
    errors: {
      ...
      WEB3_ADDRESS_INVALID: 'The wallet address is invalid.',
      WEB3_CHAIN_ID_INVALID: 'The wallet network identifier is invalid.',
      WEB3_CHALLENGE_NOT_FOUND: 'The signing request was not found or has expired.',
      WEB3_CHALLENGE_EXPIRED: 'The signing request has expired. Please try again.',
      WEB3_CHALLENGE_CONSUMED: 'This signing request has already been used.',
      WEB3_CHALLENGE_SESSION_MISMATCH: 'The signing request belongs to another browser session. Please try again.',
      WEB3_SIGNATURE_INVALID: 'The wallet signature could not be verified.',
      WEB3_IDENTITY_NOT_FOUND: 'This wallet is not registered.',
      WEB3_IDENTITY_EXISTS: 'This wallet is already registered.',
      WEB3_USERNAME_REQUIRED: 'Username is required.',
      WEB3_USERNAME_TOO_SHORT: 'Username must contain at least 2 characters.',
      WEB3_USERNAME_TOO_LONG: 'Username must contain at most 100 characters.',
      WEB3_USERNAME_INVALID: 'Username contains invalid characters.',
      WEB3_FRONTEND_URL_NOT_CONFIGURED: 'Web3 authentication is not configured correctly. Please contact the administrator.',
    },
    web3: {
      emailTab: 'Email',
      walletTab: 'Web3 Wallet',
      loginTitle: 'Web3 Login',
      registerTitle: 'Web3 Registration',
      loginSubtitle: 'Connect your wallet and sign a message to continue',
      registerSubtitle: 'Create an account using an EVM wallet address',
      usernameLabel: 'Username',
      usernamePlaceholder: 'Enter your username',
      usernameHint: 'A username is required. You can change it later in your profile.',
      usernameErrors: {
        required: 'Username is required.',
        tooShort: 'Username must contain at least 2 characters.',
        tooLong: 'Username must contain at most 100 characters.',
        invalid: 'Username contains invalid characters.',
      },
      walletNotFound: 'No injected EVM wallet was detected. Install or enable a browser wallet, then reload this page.',
      connectedWallet: 'Connected wallet',
      chainId: 'Current EVM Chain ID: {chainId}',
      connectWallet: 'Connect Wallet',
      connecting: 'Connecting wallet...',
      waitingForSignature: 'Waiting for signature...',
      signIn: 'Sign Message and Sign In',
      register: 'Sign Message and Register',
      noGas: 'This signs an off-chain message only. It does not send a transaction or cost gas.',
      eoaOnly: 'Version 1 supports EOA wallets only. Smart contract wallets such as Safe are not supported.',
      recoveryWarning: 'No email is required. If you lose this wallet, the account cannot be recovered in version 1.',
      settingsFailed: 'Failed to load authentication settings.',
      connectFailed: 'Unable to connect the wallet.',
      accountMissing: 'The wallet did not return an account.',
      chainInvalid: 'The wallet returned an invalid chain ID.',
      loginFailed: 'Web3 login failed. Please try again.',
      registrationFailed: 'Web3 registration failed. Please try again.',
    },
